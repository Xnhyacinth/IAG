...
# nohup bash scripts/image.sh 2 2,3 4 0.5 2 100000 hylora kl no cbqa 1e-3 5 base NQ train all use_context > logs/hylora_kl_notrain_cbqa_lr5e-3_base_5_all_use_context_100000.log 2>&1 &
# sleep 10
# nohup bash scripts/image.sh 2 2,3 4 0.5 2 100000 hylora kl no cbqa 1e-3 5 base TQA train all use_context > logs_tqa/hylora_kl_notrain_cbqa_lr1e-3_base_5_all_use_context_100000.log 2>&1 &
# sleep 10
