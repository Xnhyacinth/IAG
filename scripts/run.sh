...
nohup bash scripts/image.sh 2 0,1 4 2500 2 50000 hylora kl no gen 1e-3 5 base NQ train all use_context > logs/hylora_kl_notrain_gen_lr1e-3_base_5_all_usecontext.log 2>&1 &
