...
# fid
# nohup bash scripts/image.sh 2 1,6 4 2500 2 50000 fid no no gen 1e-4 10 large NQ train all 100 > logs/fid_nods_notrain_gen_lr1e-4_large_10_all_100.log 2>&1 &
nohup bash scripts/image.sh 2 1,6 4 2500 2 50000 fid no no gen 1e-4 10 large TQA train all 100 > logs_tqa/fid_nods_notrain_gen_lr1e-4_large_10_all_100.log 2>&1 &
