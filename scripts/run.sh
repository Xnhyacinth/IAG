...
# fid
nohup bash scripts/image.sh 1 0 4 2500 2 50000 fid no no gen 1e-4 10 large NQ train all no 50 > logs/fid_nods_notrain_gen_lr1e-4_large_10_all_50.log 2>&1 &
# nohup bash scripts/image.sh 2 1,6 4 2500 2 50000 fid no no gen 1e-4 10 large TQA train no all 100 > logs_tqa/fid_nods_notrain_gen_lr1e-4_large_10_all_100.log 2>&1 &
...
# nohup bash scripts/image.sh 2 2,3 4 2500 2 50000 hylora kl no gen 1e-4 5 base NQ train all use_context > logs/hylora_kl_notrain_gen_lr1e-4_base_5_all_usecontext.log 2>&1 &
