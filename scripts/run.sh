...
# hylora_all_base
# nohup bash scripts/image.sh 2 2,3 4 1000 2 50000 hylora all no gen 1e-3 10 base NQ train > logs/hylora_all_notrain_gen_lr1e-3_base_10.log 2>&1 &
...
# hylora_kl_large_5
nohup bash scripts/image.sh 2 4,5 8 1000 1 50000 hylora kl no gen 1e-3 5 large NQ > logs/hylora_kl_notrain_gen_lr1e-3_large_5.log 2>&1 &
...
# tqa_hylora_gen_kl
# nohup bash scripts/image.sh 2 4,5 4 1000 2 50000 hylora kl no gen 1e-3 1 base TQA train > logs_tqa/hylora_kl_notrain_gen_lr1e-3_base_1.log 2>&1 &
