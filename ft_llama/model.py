...
class AdapterWrapper(transformers.LlamaForCausalLM):
    """
    ...
    def __init__(self, model, embedding_dim, weights, args=None):
        super(AdapterWrapper, self).__init__(model.config)
    # def __init__(self, config):
    #     super(AdapterWrapper, self).__init__(config)
        self.model = model
        ...
        if 'llama' in self.model.config.model_type:
            ...
            down_dim = self.model.config.d_kv * self.model.config.num_heads
            input_dim = self.model.config.d_model
...
class LlamaLoraWrapper(AdapterWrapper):
    def __init__(self, model=None, embedding_dim=None, weights=None, args=None):
        super().__init__(model, embedding_dim, weights, args)
...
class AdapterWrappertest(transformers.LlamaForCausalLM):
    """
    General Wrapper Class for Hypernet Config
    ...
    def __init__(self, config):
        super(AdapterWrappertest, self).__init__(config)
    # def __init__(self, config):
    #     super(AdapterWrapper, self).__init__(config)
...
class LlamaLoraWrappertest(AdapterWrappertest):
    def __init__(self):
        super().__init__()
